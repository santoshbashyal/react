...
export const HomeHeader = ({ user }) => {
  ...
  return (
    // recieve the data from [ props] or,
    //  create a data and store
    <>
      <nav className="bg-primary-100 dark:bg-primary-800 antialiased">
        <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
          <div className="flex items-center justify-between">
              ...
              <ul className="hidden lg:flex items-center justify-start gap-6 md:gap-8 py-3 sm:justify-center">
                <li>
                  <NavLink
                    to="/"
                    title=""
                    className="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-100"
                  >
                    Home
                  </NavLink>
                </li>
                ...
                <li className="shrink-0">
                  <NavLink
                    to="#"
                    title=""
                    className="text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-100"
                  >
                    Today's Deals
                  </NavLink>
                </li>
            ...
            <div className="flex items-center lg:space-x-2">
              <button
                ...
                type="button"
                className="inline-flex items-center rounded-lg justify-center p-2 hover:bg-primary-100 dark:hover:bg-primary-700 text-sm font-medium leading-none text-gray-900 dark:text-white"
              >
              ...
              <div
                id="userDropdown1"
                className="hidden z-10 w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow dark:divide-gray-600 dark:bg-primary-700"
              >
                {" "}
                {user ? (
                  <>
              ...
              <button
                ...
                aria-expanded="false"
                className="inline-flex lg:hidden items-center justify-center hover:bg-primary-100 rounded-md dark:hover:bg-primary-700 p-2 text-gray-900 dark:text-white"
              >
          ...
          <div
            ...
            className="bg-primary-50 dark:bg-primary-700 dark:border-gray-600 border border-gray-200 rounded-lg py-3 hidden px-4 mt-4"
          >
            <ul className="text-gray-900 dark:text-white text-sm font-medium space-y-3">
              <li>
                <a
                  href="#"
                  className="hover:text-primary-700 dark:hover:text-primary-100"
                >
                  Home
                </a>
              </li>
