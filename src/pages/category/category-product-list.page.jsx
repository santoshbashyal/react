...
import SingleProductGrid from "../../components/products/single-productgrid";
...
const CategorywiseProductList = () => {
  ...
  //   console.log(query);
  //   console.log(query.get("delivery"));

  //   useEffect(() => {
  //     setTimeout(() => {
  //       setQuery({
  //         delivery: "dell",
  //         rating: query.get("delivery"),
  //       });
  //     }, 4000);
  //   });
  ...
  return (
    <>
      <section className="bg-primary-50 py-8 antialiased dark:bg-primary-900 md:py-12">
          ...
          <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                type="button"
                className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-primary-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto"
              >
                <svg
              ...
              <div
                id="dropdownSort1"
                className="z-50 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-primary-700"
        ...
        >
          <div className="relative h-full w-full max-w-xl md:h-auto">
            {/* <!-- Modal content --> */}
            <div className="relative rounded-lg bg-white shadow dark:bg-primary-800">
              {/* <!-- Modal header --> */}
              ...
              <div className="px-4 md:px-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          type="checkbox"
                          defaultValue=""
                          className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-primary-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                        />
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          defaultValue="300"
                          step="1"
                          className="h-2 w-full cursor-pointer appearance-none rounded-lg bg-gray-200 dark:bg-primary-700"
                        />
                      </div>
                      ...
                      <div className="col-span-2 flex items-center justify-between space-x-2">
                        <input
                          ...
                          min="0"
                          max="7000"
                          className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-primary-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 "
                          placeholder=""
                          required
                        />
                  ...
                  <div>
                    ...
                    <ul className="flex w-full items-center rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-primary-700 dark:text-white">
                      <li className="w-full border-r border-gray-200 dark:border-gray-600">
                        <div className="flex items-center pl-3">
                          <input
                            ...
                            name="list-radio"
                            defaultChecked
                            className="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-primary-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
                          />
                          <label
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <input
                            ...
                            defaultValue=""
                            name="rating"
                            className="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-primary-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                          />
                          <label
                            htmlFor="five-stars"
              ...
              <div className="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
                <button
                  type="submit"
                  className="rounded-lg bg-primary-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primaryary-700 dark:hover:bg-primary-800 dark:focus:ring-primary-800"
                >
                  Show 50 results
                </button>
                <button
                  type="reset"
                  className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-primary-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                >
                  Reset
                </button>
              </div>
