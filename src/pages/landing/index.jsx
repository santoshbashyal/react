...
function LandingPage() {
  ...
  return (
    <>
      <Carousel />
      <section className="bg-gray-50 py-8 antialiased dark:bg-primary-900 md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <a
              ...
              className="flex items-center rounded-lg border border-gray-200 bg-primary-200 px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-primary-800 dark:hover:bg-gray-700"
            >
              <svg
